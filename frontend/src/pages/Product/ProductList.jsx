...
const ProductList = () => {
  ...
  const fetchProducts = async () => {
    try {
      const res = await axios.get('https://inventory-mern-oh02.onrender.com/api/products/');
  ...
  const deleteProduct = async (productId) => {
    ...
    try {
      await axios.delete(`https://inventory-mern-oh02.onrender.com/api/products/delete/${productId}`);
